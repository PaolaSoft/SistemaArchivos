...
public class Descripcion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 420, 150, 40));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Paola\\Pictures\\SO\\sistema_de_archivos.jpg")); // NOI18N
        jLabel2.setMaximumSize(new java.awt.Dimension(150, 249));
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 120, 300, 270));
    ...
    private void inglesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inglesActionPerformed
        // TODO add your handling code here:
        jTextPane1.setText("The file system or file system is the component of the operating system responsible for managing and facilitating the use of peripheral memories, whether secondary or tertiary.\n" +
"\n" +
"Its main functions are the allocation of space to the files, the administration of free space and access to protected data. They structure the information stored in a data storage device or storage unit (usually a hard disk of a computer), which will then be represented either textually or graphically using a file manager.\n" +
"\n" +
"Most operating systems handle their own file system.\n" +
"\n" +
"\n" +
"Taken on 19 / August / 18 of: [https://es.wikipedia.org/wiki/Sistema_de_archivos]");
